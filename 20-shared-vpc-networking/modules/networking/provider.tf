module "tfe_oidc" {
  ...
  source                             = "github.com/praveenadoni4456/cloud-foundation-fabric.git/cloud-foundation-fabric.git//blueprints/cloud-operations/terraform-enterprise-wif/tfc-workflow-using-wif/tfc-oidc"
